Feature: Import Existing Wallet
  ...
  Scenario: Restoring Existing  Wallet
    ...
    Then : I can enter "ad" into "input text box2"
    And : Cursor should be moved to "input text box3"
    And : I can select "adapt" from suggested words
    When : I enter "ad" into "input text box3"
    Then : I cannot see "adapt" from suggested words
    When : I delete "ad" from "input text box3"
    And : I enter "almost" into "input text box3"
